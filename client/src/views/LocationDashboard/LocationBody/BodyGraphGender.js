...
// Graph
import GraphGender from "../../../components/Graph/GraphGender";
// Tooltip text
const movetooltip = `
...
class BodyGraphGender extends Component {
  render() {
...
BodyGraphGender.propTypes = {
    classes: propTypes.object.isRequired
};


export default withStyles(dashboardStyle)(BodyGraphGender);